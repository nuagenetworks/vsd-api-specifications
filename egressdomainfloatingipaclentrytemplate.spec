{
    "attributes": {
        ...
        "stateful": {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "True means that this ACL entry is stateful, so there will be a corresponding egress rule that will be created by OVS in the network. false means that there is no corresponding egress rule created by OVS in the network.",
            "exposed": true,
            "filterable": true,
            "format": null,
            "max_length": null,
