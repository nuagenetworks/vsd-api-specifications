{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "The action of the ACL entry DROP or FORWARD or REDIRECT. Action REDIRECT is allowed only for EgressAdvancedForwardingEntry Possible values are DROP, FORWARD, REDIRECT, .",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": null,
