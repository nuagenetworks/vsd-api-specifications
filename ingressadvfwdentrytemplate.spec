{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "The action of the ACL entry DROP or FORWARD or REDIRECT or PATH_FORWARDING_LIST. Actions REDIRECT and PATH_FORWARDING_LIST are allowed only for IngressAdvancedForwardingEntry. Possible values are DROP, FORWARD, REDIRECT, PATH_FORWARDING_LIST. If PATH_FORWARDING_LIST is selected in IngressAdvancedForwardingEntry, user will have to attach a ForwardingPathList (list of forwarding action-uplink preference entries) to the ACL.  ",
            "exposed": true,
            "filterable": true,
            "format": null,
            "max_length": null,
