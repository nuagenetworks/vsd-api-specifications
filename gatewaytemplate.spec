{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": "1",
            "deprecated": false,
            "description": "Default Native VLAN to carry untagged traffic on the ports of the gateways using this template. Applicable for Cisco 9K only. Possible values are 1-3967.",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": 255,
