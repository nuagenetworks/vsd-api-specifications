{
    "attributes": {
        ...
        "duplex": {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "Port Duplex :  Supported values are FULL where both parties can communicate to the other simultaneously and HALF where each party can only communicate to each other in one direction at a time.",
            "exposed": true,
            "filterable": true,
            "format": null,
            "max_length": null,
