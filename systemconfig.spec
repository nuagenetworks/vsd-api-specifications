{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "Defines the timeout in seconds for vport initialization to stateful. Default value is 300 secs \"\n            + \"and the timeout should be between 0 to 86400 seconds.",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": null,
