{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": "0",
            "deprecated": false,
            "description": "The color encoded with a traffic engineering constraint such as minimum latency, hops, maximum bandwidth, etc. This is used for NFIX(Network Function Interconnect). Color is applicable only when the selected l2EncapType is MPLS. Valid range is 1 - 4294967295. 0 for other Tunnel Types.",
            "exposed": true,
            "filterable": false,
            "format": null,
            "max_length": null,
