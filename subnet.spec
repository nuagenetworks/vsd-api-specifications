{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "The Route Distinguisher value assigned by VSD for this subnet that is used by the BGP-EVPN protocol in VSC. Supported formats are: [2-byte ASN]:[4-byte value] or [4-byte ASN]:[2-byte value]",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": 255,
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "The Route Target value assigned by VSD for this subnet that is used by the BGP-EVPN protocol in VSC. Supported formats are: [2-byte ASN]:[4-byte value] or [4-byte ASN]:[2-byte value]",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": 255,
