{
    "attributes": [
        ...
        },
        {
            ...
            "deprecated": false,
            "description": "Indicates the FEC (Forward Error Correction) setting on this Virtual Uplink. Possible values are Active(Encode & Decode on all paths over this uplink), Passive(Encode & Decode only to uplinks with FEC Active) and Disabled(do not Encode or Decode, do not detect or report loss).",
            "exposed": true,
            "filterable": true,
            "format": null,
            "max_length": null,
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "IP format of system generated identifier of the peer NSG.",
            "exposed": true,
            "filterable": false,
            "format": "free",
            "max_length": null,
            ...
            "unique": false,
            "uniqueScope": null,
            "userlabel": "Peer Gateway System ID"
        },
        {
            "allowed_chars": null,
            "allowed_choices": null,
