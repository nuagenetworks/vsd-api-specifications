{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "backHaulRouteDistinguisher of the Shared Resource. Supported formats are: [2-byte ASN]:[4-byte value] or [4-byte ASN]:[2-byte value]",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": null,
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "backHaulRouteTarget of the Shared Resource. Supported formats are: [2-byte ASN]:[4-byte value] or [4-byte ASN]:[2-byte value]",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": null,
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "Route distinguisher configured on the shared resource subnetwork. Supported formats are: [2-byte ASN]:[4-byte value] or [4-byte ASN]:[2-byte value]",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": null,
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": false,
            "description": "Route target configured on the shared resource subnetwork. Supported formats are: [2-byte ASN]:[4-byte value] or [4-byte ASN]:[2-byte value]",
            "exposed": true,
            "filterable": true,
            "format": "free",
            "max_length": null,
